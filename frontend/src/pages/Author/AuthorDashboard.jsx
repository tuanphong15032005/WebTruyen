            ...
            <div className="author-dashboard reader-view">
                <div className="reader-content">
                    ...
                    <div className="reader-info">
                        <p>Bạn hiện đang có vai trò người đọc. Để truy cập vào trang quản lý của tác giả, bạn cần đăng ký trở thành tác giả.</p>
    ...
    if (showApplicationForm) {
        return (
            <div className="author-dashboard application-view">
                <AuthorApplicationForm onApplicationSuccess={handleApplicationSuccess} />
