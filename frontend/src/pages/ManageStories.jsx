  ...
  useEffect(() => {
    const fetchStories = async () => {
      try {
        ...
        notify('Không tải được danh sách truyện của bạn', 'error');
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <section className='story-hub'>
      <header className='story-hub__header'>
        ...
        <p>Toàn bộ truyện bạn sáng tác và cập nhật chương mới.</p>
      </header>
      ...
      {loading && (
        <p className='story-hub__muted'>Đang tải danh sách truyện...</p>
      )}
