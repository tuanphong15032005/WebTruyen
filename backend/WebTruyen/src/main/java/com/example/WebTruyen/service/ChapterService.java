...
public interface ChapterService {
    ...
    // --- Các method mới từ nhánh author-create-content ---
    CreateChapterResponse createChapterFromHtml(UserEntity currentUser, Long storyId, Long volumeId, CreateChapterRequest req);
    CreateChapterResponse updateChapterFromHtml(UserEntity currentUser, Long storyId, Long volumeId, Long chapterId, CreateChapterRequest req);
